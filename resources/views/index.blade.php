...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-CE3M38V8H7"></script>
    <script>
        ...
        gtag('config', 'G-CE3M38V8H7');
    </script>

    <!-- fav icon -->
    <link rel="icon" href="{{ asset('assets/images/logo/main.png') }}" />
...
<body class="dark-theme landing-page-demo">
        ...
        <div class="container">
            ...
            <nav class="menu-navbar" id="main-nav">
                <div class="header-logo">
                    <a class="logo-link" href="#"><img class="logo-img light-logo" loading="lazy"
                            src="assets/images/logo/main.png" alt="logo" /><img class="logo-img dark-logo"
                            loading="lazy" src="assets/images/logo/main.png" alt="logo" /></a>
                    <h2>Rotation</h2>
                </div>
                ...
                <div class="controls-box">
                    ...
                    <div class="control dropdown language-switcher d-none d-lg-block">
                            ...
                            <div class="col-12">
                                <div class="hero-social-icons mb-3">
                                    <div class="sc-wrapper dir-row sc-flat">
                                        <ul class="sc-list">
                                            <li class="sc-item">
                                                <a class="sc-link" href="https://www.linkedin.com/company/rotation-uz"
                                                    title="linkedin"><i class="fab fa-linkedin sc-icon"></i></a>
                                            </li>
                                            <li class="sc-item">
                                                <a class="sc-link" href="https://github.com/rotation-uz"
                                                    title="github"><i class="fab fa-github sc-icon"></i></a>
                                            </li>
                                            <li class="sc-item">
                                                <a class="sc-link" href="https://www.instagram.com/rotation_uz/"
                                                    title="instagram"><i class="fab fa-instagram sc-icon"></i></a>
                                            </li>
                                            <li class="sc-item">
                                                <a class="sc-link" href="https://t.me/rotation_uz"
                                                    title="telegram"><i class="fab fa-telegram sc-icon"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-12 mx-md-auto col-lg-6 text-center" data-tilt>
                    <div class="hero-image-area mb-5 mb-lg-0">
                        <div class="hero-img-wraper">
                            <img class="img-fluid" src="assets/images/hero/illustration-1.png" alt=""
                                draggable="false" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 d-flex align-items-center order-0 order-lg-1 about-col wow fadeInUp"
                        ...
                        <div class="img-area" data-tilt>
                            <div class="image">
                                <img class="about-img img-fluid" loading="lazy" src="assets/images/about/3.png"
                                    alt="Our vision" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-6 d-flex align-items-center about-col wow fadeInUp"
                        ...
                        <div class="img-area">
                            <div class="image" data-tilt>
                                <img class="about-img img-fluid" loading="lazy" src="assets/images/about/1.png"
                                    alt="about" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="portfolio-wrapper">
                ...
                <div class="portfolio-group wow fadeIn" data-wow-delay=".4s">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 portfolio-item mobile">
                            <div class="item">
                                <a class="portfolio-img-link" href="assets/images/portfolio/img11.png"
                                    data-fancybox=".show-in-fancybox"><img class="portfolio-img img-fluid"
                                        loading="lazy" src="assets/images/portfolio/img11.png"
                                        alt="portfolio item photo" /></a>
                                <div class="item-info">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 portfolio-item web">
                            <div class="item">
                                <a class="portfolio-img-link" href="assets/images/portfolio/img8.png"
                                    data-fancybox=".show-in-fancybox"><img class="portfolio-img img-fluid"
                                        loading="lazy" src="assets/images/portfolio/img8.png"
                                        alt="portfolio item photo" /></a>
                                <div class="item-info">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 portfolio-item hosting">
                            <div class="item">
                                <a class="portfolio-img-link" href="assets/images/portfolio/img1.png"
                                    data-fancybox=".show-in-fancybox"><img class="portfolio-img img-fluid"
                                        loading="lazy" src="assets/images/portfolio/img1.png"
                                        alt="portfolio item photo" /></a>
                                <div class="item-info">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 portfolio-item hosting">
                            <div class="item">
                                <a class="portfolio-img-link" href="assets/images/portfolio/img16.png"
                                    data-fancybox=".show-in-fancybox"><img class="portfolio-img img-fluid"
                                        loading="lazy" src="assets/images/portfolio/img16.png"
                                        alt="portfolio item photo" /></a>
                                <div class="item-info">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 portfolio-item mobile">
                            <div class="item">
                                <a class="portfolio-img-link" href="assets/images/portfolio/img13.png"
                                    data-fancybox=".show-in-fancybox"><img class="portfolio-img img-fluid"
                                        loading="lazy" src="assets/images/portfolio/img13.png"
                                        alt="portfolio item photo" /></a>
                                <div class="item-info">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 portfolio-item mobile">
                            <div class="item">
                                <a class="portfolio-img-link" href="assets/images/portfolio/img14.png"
                                    data-fancybox=".show-in-fancybox"><img class="portfolio-img img-fluid"
                                        loading="lazy" src="assets/images/portfolio/img14.png"
                                        alt="portfolio item photo" /></a>
                                <div class="item-info">
            ...
            <div class="row">
                <div class="col-12 col-lg-5 align-self-center">
                    <div class="faq-img start-dir-img-frame wow fadeIn" data-wow-delay="0.2s">
                        <img class="img-fluid" loading="lazy" src="assets/images/faq/faq-illustration.png"
                            alt="" />
                    </div>
                </div>
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="input-wrapper">
                                                    ...
                                                    <label class="input-label" for="user-name">
                                                        Name <span class="req">*</span></label><span
                                            ...
                                            <div class="col-12 col-lg-6">
                                                <div class="input-wrapper">
                                                    ...
                                                    <label class="input-label" for="user-email">
                                                        E-mail <span class="req">*</span></label><span
                                                        class="b-border"></span><span class="error-msg"></span>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-wrapper">
                                                    ...
                                                    <label class="input-label" for="msg-subject">
                                                        Subject <span class="req">*</span></label><span
                                                        class="b-border"></span><span class="error-msg"></span>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="input-wrapper">
                                                    ...
                                                    <label class="input-label" for="msg-text">
                                                        your message <span class="req">*</span></label><span
                                ...
                                <div class="info-panel wow fadeInUp" data-wow-delay=".4s ">
                                    ...
                                    <div class="location-card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <a class="email link"
                                                href="mailto:abbosovibrohim183@gmail.com">abbosovibrohim183@gmail.com</a>
                                        </div>
                                    </div>
                                    <div class="location-card">
                                        ...
                                        <div class="card-content">
                                            ...
                                            <a class="tel link" href="tel:0123456789">+998 90 001-29-19</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-panel wow fadeInUp" data-wow-delay=".6s">
                                    ...
                                    <div class="location-card">
                                        ...
                                        <div class="card-content">
                                            <h6 class="content-title">email:</h6>
                                            <a class="email link"
                                                href="mailto:yourname@example.com">dilnozanishanova6@gmail.com</a>
                                        </div>
                                    </div>
                                    <div class="location-card">
                                        <i class="flaticon-phone-call icon"></i>
                                        <div class="card-content">
                                            <h6 class="content-title">phone:</h6>
                                            <a class="tel link" href="tel:0123456789">+998 94 652-75-88</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-panel wow fadeInUp" data-wow-delay=".8s">
                                    ...
                                    <div class="location-card">
                                        ...
                                        <div class="card-content">
                                            <h6 class="content-title">email:</h6>
                                            <a class="email link"
                                                href="mailto:yourname@example.com">shukronaalisherova0424@gmail.com</a>
                                        </div>
                                    </div>
                                    <div class="location-card">
                                        <i class="flaticon-phone-call icon"></i>
                                        <div class="card-content">
                                            <h6 class="content-title">phone:</h6>
                                            <a class="tel link" href="tel:0123456789">+998 99 750 77 27</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mapouter">
                        <div class="gmap_canvas">
                            ...
                            <iframe class="map-iframe" id="gmap_canvas"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2995.9133575036353!2d69.26195337591554!3d41.33249737130691!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8b6cbd7e49a1%3A0xf23c3817c486d743!2sAmity%20University%20Tashkent!5e0!3m2!1sen!2s!4v1740592746319!5m2!1sen!2s"></iframe>
                        </div>
                    </div>
                </div>
            </section>
    ...
    <footer class="page-footer dark-color-footer" id="page-footer">
        <div class="overlay-photo-image-bg" data-bg-img="assets/images/sections-bg-images/main.jpg"
            data-bg-opacity=".25"></div>
        <div class="container">
            <div class="row footer-cols">
                <div class="col-12 col-md-8 col-lg-4 footer-col">
                    <img class="img-fluid footer-logo" loading="lazy" src="assets/images/logo/main.png"
                        alt="logo" />
                ...
                <div class="col-12 col-lg-4 footer-col">
                    ...
                    <div class="footer-col-content-wrapper">
                        ...
                        <div class="contact-info-card">
                            <i class="bi bi-geo-alt icon"></i><span class="text-lowercase info">Sergeli district
                                Tursunzoda 19.</span>
                        </div>
                        <div class="contact-info-card">
                            <i class="bi bi-phone icon"></i><a class="info" href="tel:+20123456789">+998 90
                                001-29-19 </a>
                        </div>
                        <div class="contact-info-card">
                            <div class="social-icons">
                                <div class="sc-wrapper dir-row sc-size-32">
                                    <ul class="sc-list">
                                        ...
                                        <li class="sc-item">
                                            <a class="sc-link" href="https://t.me/rotation_uz" title="telegram"><i
                                                    class="fab fa-telegram sc-icon"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <div class="loading-screen" id="loading-screen">
        <span class="bar top-bar"></span><span class="bar down-bar"></span><span class="progress-line"></span><span
            class="loading-counter"> </span>
    </div>
